    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <nav aria-label="Primary navigation">
          ...
          <a className="nav-item" href="#patients"><span className="nav-symbol">◎</span>Patients<span className="nav-count">{patients.length}</span></a>
        ...
        <section className="workspace-grid" id="patients">
          <div className="queue-panel">
            <div className="panel-heading">
              <div><div className="title-row"><h2>Patient priority</h2><span>{patients.length} active</span></div><p>Ranked by clinical rules, trend changes, and missed care tasks.</p></div>
